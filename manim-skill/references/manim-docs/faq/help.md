...
is not already discussed in our [FAQ section](index.md) sufficiently
...
[Code of Conduct](../conduct.md) – in short, be *excellent* to one another:
...
1. Make sure you are running the latest released version of Manim, your problem
   ...
   [Changelog](../changelog.md) for a full list of changes between Manim releases.
2. Choose the correct category for your report when
   ...
   *installation issues*. If your report falls into one of these
   ...
   [the instructions given in this answer](#creating-suggestions).
