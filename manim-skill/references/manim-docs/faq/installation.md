...
[written installation guide](../installation.md) to guide you through the process.
...
If you have followed [our local installation instructions](../installation/uv.md) and
...
your problem. See the [FAQ on getting help](help.md) for instructions.
...
- and if you still run into troubles after that, please reach out to
  us as described in the [Getting Help FAQs](help.md).
