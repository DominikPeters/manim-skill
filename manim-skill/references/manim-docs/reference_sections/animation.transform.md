...
| [`TransformFromCopy`](manim.animation.transform.TransformFromCopy.md#manim.animation.transform.TransformFromCopy)                                        | Preserves a copy of the original VMobject and transforms only it's copy to the target VMobject |
